...
# Collect user inputs
present_price = st.number_input("Present Price (in Lakhs)", min_value=50000,max_value=100000,format="%.2f")
kms_driven = st.number_input("Kms Driven", min_value=0,max_value=300000,step=1000)
